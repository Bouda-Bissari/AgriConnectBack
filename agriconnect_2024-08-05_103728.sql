...
--
-- Host: 127.0.0.1    Database: agriconnect
-- ------------------------------------------------------
...
CREATE TABLE `services` (
    ...
    `service_type` enum('work', 'material') NOT NULL,
...
CREATE TABLE `users` (
    ...
    `two_factor_enable` tinyint(1) NOT NULL DEFAULT 0,
...
--
-- Dumping routines for database 'agriconnect'
--
...
-- Dump completed on 2024-08-05 10:37:35